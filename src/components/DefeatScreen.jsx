...
export default function DefeatScreen() {
  ...
  return (
    <div className="absolute inset-0 z-40 overflow-hidden">
      ...
      {/* Contenido */}
      <div className="relative z-10 flex h-full w-full flex-col items-center justify-center gap-[2.5cqh] px-[6cqw]">
        <motion.div
          className="text-[11cqh]"
        ...
        <motion.h2
          className="font-display text-[6cqh] text-white text-stroke-lg"
        ...
        <motion.div
          className="parchment relative w-[70cqw] max-w-[110cqh] rounded-[1.5cqh] px-[5cqw] py-[3.5cqh] text-center"
          initial={{ opacity: 0, scale: 0.7, y: 30 }}
          animate={{ opacity: 1, scale: 1, y: 0 }}
          transition={{ delay: 0.3, type: 'spring', stiffness: 220, damping: 18 }}
        >
          <div className="mb-[1cqh] text-[4cqh]">📜</div>
          <p className="font-body text-[3cqh] font-bold italic leading-snug text-[#5b3d12]">
            “{verse.text}”
          </p>
          <p className="mt-[1.5cqh] font-display text-[3.2cqh] text-wood-grain" style={{ textShadow: '0 1px 0 rgba(255,255,255,0.5)' }}>
            — {verse.ref}
          </p>
        </motion.div>
